...
## [0.2.0](https://github.com/cyberdak/deepagents/compare/deepagents-code==0.1.47...deepagents-code==0.2.0) (2026-07-27)


### ⚠ BREAKING CHANGES

* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/cyberdak/deepagents/issues/4929))

### Features

* **code,evals:** GLM-5.2 harness profile ([#4710](https://github.com/cyberdak/deepagents/issues/4710)) ([47cfc33](https://github.com/cyberdak/deepagents/commit/47cfc33cf9145347b57eb2daf6ef82cdaa342ca4))
* **code,sdk:** add rubric iteration controls ([#4405](https://github.com/cyberdak/deepagents/issues/4405)) ([d6692a7](https://github.com/cyberdak/deepagents/commit/d6692a7c713490f170b17510d613e02ee37574ab))
* **code:** `/model` Ctrl+N toggle for names vs raw specs ([#4592](https://github.com/cyberdak/deepagents/issues/4592)) ([518c322](https://github.com/cyberdak/deepagents/commit/518c322e7dda840b5a740541afc895516a74925f))
* **code:** `/tools` slash command ([#4649](https://github.com/cyberdak/deepagents/issues/4649)) ([b1600a8](https://github.com/cyberdak/deepagents/commit/b1600a8da784899d9db5bdf93be07b4c7f53a46c))
* **code:** `tool.use` and `tool.result` hook events ([#3954](https://github.com/cyberdak/deepagents/issues/3954)) ([ba1979d](https://github.com/cyberdak/deepagents/commit/ba1979d64c3ed5e96ebc896197bc8f97f6f84bac))
* **code:** add "always allow" to project MCP approval prompt ([#4562](https://github.com/cyberdak/deepagents/issues/4562)) ([ffab82a](https://github.com/cyberdak/deepagents/commit/ffab82a9458d2a03b95cbc515f883212090a6992))
* **code:** add `--allow-fs-tools` filesystem tool allowlist to dcode ([#4635](https://github.com/cyberdak/deepagents/issues/4635)) ([3fbb85e](https://github.com/cyberdak/deepagents/commit/3fbb85e3565f270f3a567f771ebd28323f10245d))
* **code:** add `-s` alias for `--skill` ([#4620](https://github.com/cyberdak/deepagents/issues/4620)) ([c9b7ac2](https://github.com/cyberdak/deepagents/commit/c9b7ac20752e4270d286b4af3fcf710e7e5bee87))
* **code:** add `[startup].mode` default approval mode ([#4573](https://github.com/cyberdak/deepagents/issues/4573)) ([7c5bf54](https://github.com/cyberdak/deepagents/commit/7c5bf542c2f58fa46ecd708c66cd1817a0ebdc41))
* **code:** add `Ctrl+X` to goal review editing ([#4780](https://github.com/cyberdak/deepagents/issues/4780)) ([641b906](https://github.com/cyberdak/deepagents/commit/641b906157db2c6ae476805f0714ae8f51040492))
* **code:** add `dcode tools list` command ([#4461](https://github.com/cyberdak/deepagents/issues/4461)) ([1402d0e](https://github.com/cyberdak/deepagents/commit/1402d0e735a1580503f240457c77db76fcd779d7))
* **code:** add `GPT-5.6` model family ([#4600](https://github.com/cyberdak/deepagents/issues/4600)) ([4a806bc](https://github.com/cyberdak/deepagents/commit/4a806bc703b69334cccd05bcd27d411602e82318))
* **code:** add `memory.auto_save` config flag ([#4700](https://github.com/cyberdak/deepagents/issues/4700)) ([55b60ca](https://github.com/cyberdak/deepagents/commit/55b60ca08da4eef294ac3c162610b2a151584ea5))
* **code:** add `reconnect`/`connect` hidden keywords for `/restart` ([#4807](https://github.com/cyberdak/deepagents/issues/4807)) ([99250ee](https://github.com/cyberdak/deepagents/commit/99250ee1749c977e95389baafde3d358c953ea0f))
* **code:** add built-in thread inspector skill ([#4769](https://github.com/cyberdak/deepagents/issues/4769)) ([2d729b3](https://github.com/cyberdak/deepagents/commit/2d729b30c5df7265e8062bccd38026b745c6cf02))
* **code:** add Claude Sonnet 5 to model picker ([#4386](https://github.com/cyberdak/deepagents/issues/4386)) ([64758dd](https://github.com/cyberdak/deepagents/commit/64758dddf8b46c5b68c345fb1eac1fb7bcbf7f7e))
* **code:** add configurable chat cursor style ([#4687](https://github.com/cyberdak/deepagents/issues/4687)) ([a22484b](https://github.com/cyberdak/deepagents/commit/a22484ba2e001fd62fbff0fe916f1b3b93889fc3))
* **code:** add Fireworks session settings ([#4360](https://github.com/cyberdak/deepagents/issues/4360)) ([90ebb1d](https://github.com/cyberdak/deepagents/commit/90ebb1d68cb5942f07847f6dce48c14c7caef992))
* **code:** add Grok 4.5 model ([#4596](https://github.com/cyberdak/deepagents/issues/4596)) ([b0a209d](https://github.com/cyberdak/deepagents/commit/b0a209da3a8c9f80e2e3d5e199340736c854c567))
* **code:** add Hooks v2 capability snapshots ([#4916](https://github.com/cyberdak/deepagents/issues/4916)) ([8b4e508](https://github.com/cyberdak/deepagents/commit/8b4e508d4664ef02e220854d50f5d98e0913aed8))
* **code:** add Hooks v2 execution engine ([#4880](https://github.com/cyberdak/deepagents/issues/4880)) ([f0b198f](https://github.com/cyberdak/deepagents/commit/f0b198faa220ad90f24713f08acc09d41e4a81de))
* **code:** add Hooks v2 session transcripts ([#4918](https://github.com/cyberdak/deepagents/issues/4918)) ([ca86fbe](https://github.com/cyberdak/deepagents/commit/ca86fbecca1a43facb4281397760c5e52edb1ddd))
* **code:** add interactive goal management ([#4693](https://github.com/cyberdak/deepagents/issues/4693)) ([64205e2](https://github.com/cyberdak/deepagents/commit/64205e238c280ae05b2bf9253ac40c6f85ffb49c))
* **code:** add Kimi K3 to model selector under OpenRouter ([#4803](https://github.com/cyberdak/deepagents/issues/4803)) ([fc94bb7](https://github.com/cyberdak/deepagents/commit/fc94bb7da9e66218de063aa4415dcf9717f15fce))
* **code:** add LangSmith base URL to `/auth` ([#4228](https://github.com/cyberdak/deepagents/issues/4228)) ([88d167f](https://github.com/cyberdak/deepagents/commit/88d167f9ceec1cfadd7c3feac6f63c0da7c893f1))
* **code:** add Meta model provider ([#4650](https://github.com/cyberdak/deepagents/issues/4650)) ([70829c5](https://github.com/cyberdak/deepagents/commit/70829c5846b6bdde1cee51f0f4929e819ba1026b))
* **code:** add plugin list search ([#4765](https://github.com/cyberdak/deepagents/issues/4765)) ([a6c20b1](https://github.com/cyberdak/deepagents/commit/a6c20b1a4d2a8b8a03690460a30c501ab7fbb6cb))
* **code:** add plugin marketplace support ([#4554](https://github.com/cyberdak/deepagents/issues/4554)) ([0187d14](https://github.com/cyberdak/deepagents/commit/0187d14b83301c116a2f177e6e04ae7a8cc99ca7))
* **code:** add reasoning effort selector ([#4403](https://github.com/cyberdak/deepagents/issues/4403)) ([6ee0ac4](https://github.com/cyberdak/deepagents/commit/6ee0ac4cca998f84e157187d565084e2a1912626))
* **code:** add rubric-backed goal workflow ([#4365](https://github.com/cyberdak/deepagents/issues/4365)) ([8fca61d](https://github.com/cyberdak/deepagents/commit/8fca61dc036888a4414ff5a4536b957c63dab4a5))
* **code:** add typed hooks data models ([#4870](https://github.com/cyberdak/deepagents/issues/4870)) ([0967012](https://github.com/cyberdak/deepagents/commit/09670121b8d20fa8029804143852f6fcc6135dba))
* **code:** adopt coding-agent-v1 trace metadata ([#4367](https://github.com/cyberdak/deepagents/issues/4367)) ([cb39747](https://github.com/cyberdak/deepagents/commit/cb3974748024fcec2e2ee0ccc0a9b23c880733a2))
* **code:** auto-accept `/goal` criteria in YOLO mode ([#4784](https://github.com/cyberdak/deepagents/issues/4784)) ([cc662f2](https://github.com/cyberdak/deepagents/commit/cc662f236dbf72303be5cbf2c4cfd00710a2d32c))
* **code:** auto-detect MCP OAuth from 401 challenge ([#4364](https://github.com/cyberdak/deepagents/issues/4364)) ([9763ffc](https://github.com/cyberdak/deepagents/commit/9763ffceab8800526ae9fe10decdb2f32d8e4707))
* **code:** classifier-backed Auto approval mode ([#4804](https://github.com/cyberdak/deepagents/issues/4804)) ([eae7c28](https://github.com/cyberdak/deepagents/commit/eae7c28f1152a5116b5b330c9fa1088ce173656d))
* **code:** collapse completed tool calls into group summaries ([#4373](https://github.com/cyberdak/deepagents/issues/4373)) ([3735829](https://github.com/cyberdak/deepagents/commit/3735829a0c14fb1537daf930140c66b647c8222c))
* **code:** collapse large pastes into compact placeholders ([#4447](https://github.com/cyberdak/deepagents/issues/4447)) ([9ae927d](https://github.com/cyberdak/deepagents/commit/9ae927d73ebf30ba50bbb7ec0c1076a0937e5cb7))
* **code:** configure Auto goal criteria acceptance ([#4940](https://github.com/cyberdak/deepagents/issues/4940)) ([37addfc](https://github.com/cyberdak/deepagents/commit/37addfc8bb5533d6670d14defea38770c8d54d1e))
* **code:** Debug Console thread ID click-to-copy with LangSmith link ([#4760](https://github.com/cyberdak/deepagents/issues/4760)) ([2d35507](https://github.com/cyberdak/deepagents/commit/2d35507b5c7ff7f504f3d294ac499140752c4f59))
* **code:** debug-log skill-name override collisions ([#4772](https://github.com/cyberdak/deepagents/issues/4772)) ([77603c6](https://github.com/cyberdak/deepagents/commit/77603c69e2eeededf6f1df68b384da27f7d2843f))
* **code:** drop `TodoListMiddleware` ([#4685](https://github.com/cyberdak/deepagents/issues/4685)) ([d3a3077](https://github.com/cyberdak/deepagents/commit/d3a3077e8536696dcf4a9dcd8555e9c871562e74))
* **code:** expand environment variables in MCP config ([#4681](https://github.com/cyberdak/deepagents/issues/4681)) ([4f5d7be](https://github.com/cyberdak/deepagents/commit/4f5d7be1b4073dee346e5a974841721646fa4860))
* **code:** expand truncated `task` descriptions on click or `Ctrl+O` ([#4811](https://github.com/cyberdak/deepagents/issues/4811)) ([2ddb551](https://github.com/cyberdak/deepagents/commit/2ddb551bd77d210d689f3a75037259ade4fbf54a))
* **code:** fall back to folder name for subagents ([#4504](https://github.com/cyberdak/deepagents/issues/4504)) ([9db3db5](https://github.com/cyberdak/deepagents/commit/9db3db5f31a93fb8598a5dc5bedf4fe61fe92c94))
* **code:** gate debug console click-to-copy behind a checkbox ([#4810](https://github.com/cyberdak/deepagents/issues/4810)) ([a485404](https://github.com/cyberdak/deepagents/commit/a4854042e5fe9f3acf629b0646a6bf8e348ccc9a))
* **code:** gate paste auto-collapse behind `display.collapse_pastes` ([#4473](https://github.com/cyberdak/deepagents/issues/4473)) ([ff5dd56](https://github.com/cyberdak/deepagents/commit/ff5dd564a3a590e7d2d521b20df495b5e1512e12))
* **code:** hide diff widget for credential files ([#4593](https://github.com/cyberdak/deepagents/issues/4593)) ([4c49a24](https://github.com/cyberdak/deepagents/commit/4c49a24c4c488f45859b45628cfa57719e52f596))
* **code:** improve `/goal` criteria UX ([#4694](https://github.com/cyberdak/deepagents/issues/4694)) ([06f46ff](https://github.com/cyberdak/deepagents/commit/06f46fffe36efa9f3adcb331b07df283d8bed874))
* **code:** in-app Debug Console ([#4564](https://github.com/cyberdak/deepagents/issues/4564)) ([4f94a30](https://github.com/cyberdak/deepagents/commit/4f94a30c11efb1819b08647d15b50b9b1e7bf043))
* **code:** in-the-moment trust prompt for symlinked skills ([#4200](https://github.com/cyberdak/deepagents/issues/4200)) ([a4431e4](https://github.com/cyberdak/deepagents/commit/a4431e4339348431e91533cb2b177259ab94b083))
* **code:** include `yolo` mode in `Shift+Tab` approval cycle ([#5035](https://github.com/cyberdak/deepagents/issues/5035)) ([9f2cc21](https://github.com/cyberdak/deepagents/commit/9f2cc212dc3ba59540a9f738d2849e38ac9ecfc2))
* **code:** let the rubric grader inspect working-directory files ([#4835](https://github.com/cyberdak/deepagents/issues/4835)) ([5dcf749](https://github.com/cyberdak/deepagents/commit/5dcf749a6e7d5ab6611f30d485a3382c7ef31f22))
* **code:** make plugins generally available ([#4797](https://github.com/cyberdak/deepagents/issues/4797)) ([3da6e47](https://github.com/cyberdak/deepagents/commit/3da6e471c26f1da4cddeb12a435bab92bd7866c6))
* **code:** make Version, Model, CWD copyable in Debug Console ([#4975](https://github.com/cyberdak/deepagents/issues/4975)) ([52b8993](https://github.com/cyberdak/deepagents/commit/52b8993489a9b6b92be077fe835743ef7704b6a0))
* **code:** migrate legacy hooks to v2 events ([#4971](https://github.com/cyberdak/deepagents/issues/4971)) ([fdb585c](https://github.com/cyberdak/deepagents/commit/fdb585c87b054979b8440bdc6ac97fc8ae628134))
* **code:** move `/goal` criteria generation server-side ([#4754](https://github.com/cyberdak/deepagents/issues/4754)) ([9fdd498](https://github.com/cyberdak/deepagents/commit/9fdd498937842e2ac490ae0e0ca74eef47abd0bb))
* **code:** non-interactive rubric grading flags ([#4305](https://github.com/cyberdak/deepagents/issues/4305)) ([1bcb112](https://github.com/cyberdak/deepagents/commit/1bcb112ee78138eca9cb400c206ce198322aae32))
* **code:** offer abort during resume ([#4188](https://github.com/cyberdak/deepagents/issues/4188)) ([a4c25cd](https://github.com/cyberdak/deepagents/commit/a4c25cd74de9902fd0ea9440b5dda2d4248bb3d2))
* **code:** offer abort in `/threads` cwd-switch prompt ([#4583](https://github.com/cyberdak/deepagents/issues/4583)) ([aaeac99](https://github.com/cyberdak/deepagents/commit/aaeac99d9f17b6a55d663c21a4d063444b6a1870))
* **code:** offer restart after saving Tavily key via `/auth` ([#4560](https://github.com/cyberdak/deepagents/issues/4560)) ([12df81a](https://github.com/cyberdak/deepagents/commit/12df81ad00d814c570b4d24a2b06de9b18d51abd))
* **code:** persist Debug Console `Ctrl+L` clear across reopen ([#4812](https://github.com/cyberdak/deepagents/issues/4812)) ([20089a5](https://github.com/cyberdak/deepagents/commit/20089a53703b031726fdc898831bb09f434527b7))
* **code:** persist reasoning effort across restarts ([#4728](https://github.com/cyberdak/deepagents/issues/4728)) ([c584dcf](https://github.com/cyberdak/deepagents/commit/c584dcfb3ad287446e0209b8bd4ca31cee587eea))
* **code:** persistent banner when installation is stale ([#4459](https://github.com/cyberdak/deepagents/issues/4459)) ([b74c185](https://github.com/cyberdak/deepagents/commit/b74c18591a8ce9a49a5fee43b07e602ca9fbf68a))
* **code:** raise agent recursion limit to 2000 and make it configurable ([#4994](https://github.com/cyberdak/deepagents/issues/4994)) ([94962a5](https://github.com/cyberdak/deepagents/commit/94962a5f588ce84991ad382b7713155d6a5a231e))
* **code:** reload env from `/auth` modal via Ctrl+R ([#4566](https://github.com/cyberdak/deepagents/issues/4566)) ([f07d638](https://github.com/cyberdak/deepagents/commit/f07d6387b7dc1f0e880f77784905c2aa94143adb))
* **code:** replace Gemini 3.5 Flash with 3.6 Flash in model switcher ([#4890](https://github.com/cyberdak/deepagents/issues/4890)) ([5c99687](https://github.com/cyberdak/deepagents/commit/5c99687bdecfd9e33051373581cacddbf7d0202a))
* **code:** report tracing gateway in `dcode doctor` ([#4466](https://github.com/cyberdak/deepagents/issues/4466)) ([a912427](https://github.com/cyberdak/deepagents/commit/a9124275504bc1af5f76dfdd9a6c558c98eea92d))
* **code:** restore interrupted prompt to input on ESC ([#4544](https://github.com/cyberdak/deepagents/issues/4544)) ([fccf037](https://github.com/cyberdak/deepagents/commit/fccf03732140d39749e70e8fc6cb7d73124a1d70))
* **code:** resume threads in-TUI with `/threads -r [ID]` ([#4609](https://github.com/cyberdak/deepagents/issues/4609)) ([d442673](https://github.com/cyberdak/deepagents/commit/d44267358e272553c8ece33d367514430be7c0da))
* **code:** selective per-server project MCP trust ([#4507](https://github.com/cyberdak/deepagents/issues/4507)) ([aaa22a9](https://github.com/cyberdak/deepagents/commit/aaa22a9340cb3d2c8e9ce1a921957d0a9121da20))
* **code:** set `prompt_cache_key` for OpenAI models ([#4632](https://github.com/cyberdak/deepagents/issues/4632)) ([8cf57ac](https://github.com/cyberdak/deepagents/commit/8cf57aca9f41c3c4ca6d9796dc2cb80d4b22fb6d))
* **code:** show `"Took <duration>"` after `execute` finishes ([#4301](https://github.com/cyberdak/deepagents/issues/4301)) ([a5240eb](https://github.com/cyberdak/deepagents/commit/a5240ebe3654e72fa5beb4070224f52f944768c8))
* **code:** show `(debug enabled)` on splash when `DEEPAGENTS_CODE_DEBUG` is set ([#4584](https://github.com/cyberdak/deepagents/issues/4584)) ([f10b877](https://github.com/cyberdak/deepagents/commit/f10b877e5e48c3a1e15bd72d2ce06dfb16203231))
* **code:** show changelog link before install-script update prompt ([#5034](https://github.com/cyberdak/deepagents/issues/5034)) ([e3d2a87](https://github.com/cyberdak/deepagents/commit/e3d2a870b77e548611929be56952f68825d3d52e))
* **code:** show experimental mode in splash and debug console ([#4863](https://github.com/cyberdak/deepagents/issues/4863)) ([44d9dec](https://github.com/cyberdak/deepagents/commit/44d9dec39b2570d16c285a8b0a99cbe1afab4f1b))
* **code:** show model name instead of spec in switcher ([#4460](https://github.com/cyberdak/deepagents/issues/4460)) ([0059620](https://github.com/cyberdak/deepagents/commit/005962088ad31b16745c399e4ab2e725e97f7858))
* **code:** shutdown toast for deferred exits ([#4830](https://github.com/cyberdak/deepagents/issues/4830)) ([a8a05f5](https://github.com/cyberdak/deepagents/commit/a8a05f58f2ffb755bf373cd8f9a4cced2778370c))
* **code:** simplify welcome banner to compact box ([#4482](https://github.com/cyberdak/deepagents/issues/4482)) ([b7f46e9](https://github.com/cyberdak/deepagents/commit/b7f46e931807f86476c9c2d661dcd4e9623c10a2))
* **code:** summarize plugin changes on reload ([#4767](https://github.com/cyberdak/deepagents/issues/4767)) ([9cad2f0](https://github.com/cyberdak/deepagents/commit/9cad2f00dd0473828f80f782c889b939483727f6))
* **code:** support Fireworks `/routers` model ids ([#4591](https://github.com/cyberdak/deepagents/issues/4591)) ([1c08d27](https://github.com/cyberdak/deepagents/commit/1c08d2705f73f6870610849e00910b94458accf1))
* **code:** toast on saved `/auth` API key ([#4558](https://github.com/cyberdak/deepagents/issues/4558)) ([ee3c264](https://github.com/cyberdak/deepagents/commit/ee3c26415be84e369b829fefb21461c8ec210a5e))
* **code:** toast to re-paste when a chat paste collapses ([#4742](https://github.com/cyberdak/deepagents/issues/4742)) ([e50e238](https://github.com/cyberdak/deepagents/commit/e50e2383261ba39923b5d6c48b7fe3b058475cd3))
* **code:** toast when opening a clicked URL ([#4368](https://github.com/cyberdak/deepagents/issues/4368)) ([434f29e](https://github.com/cyberdak/deepagents/commit/434f29e5cb3d94988e2a4d80b78452bee4b10812))
* **code:** trace auto-approve (YOLO) mode in trace metadata ([#4764](https://github.com/cyberdak/deepagents/issues/4764)) ([d88601e](https://github.com/cyberdak/deepagents/commit/d88601ed582b89d4a5b517e842029d06370c0891))
* **code:** trace experimental mode in metadata ([#4705](https://github.com/cyberdak/deepagents/issues/4705)) ([22d5045](https://github.com/cyberdak/deepagents/commit/22d50456324e9b8c0121a3a06787e19c1b88e1aa))
* **code:** unify `config show`/`list` around effective values ([#4174](https://github.com/cyberdak/deepagents/issues/4174)) ([ccd9d21](https://github.com/cyberdak/deepagents/commit/ccd9d216e77855a28b88850beb525f47ce8b686a))
* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/cyberdak/deepagents/issues/4929)) ([9340518](https://github.com/cyberdak/deepagents/commit/9340518a26c4287f9ad0c543edc9b69106c15154))
* **sdk:** optional video frame extraction on `read_file` ([#4094](https://github.com/cyberdak/deepagents/issues/4094)) ([b927147](https://github.com/cyberdak/deepagents/commit/b927147d026749c6c790bb06c9853515dabf579c))


### Bug Fixes

* **code,evals:** unify goal activation signaling ([#4980](https://github.com/cyberdak/deepagents/issues/4980)) ([0c4016e](https://github.com/cyberdak/deepagents/commit/0c4016e3c8a7293fdf1a24e12340759068a2bb9a))
* **code:** abort project MCP approval on Esc ([#4888](https://github.com/cyberdak/deepagents/issues/4888)) ([46bb1a8](https://github.com/cyberdak/deepagents/commit/46bb1a86c8041d5c161d7cd07de66d068fb100c0))
* **code:** abort YOLO launch on `Ctrl+C`/`Ctrl+D` ([#4953](https://github.com/cyberdak/deepagents/issues/4953)) ([e6ab9c0](https://github.com/cyberdak/deepagents/commit/e6ab9c05e8fcb9a332396a9425e2b302607be823))
* **code:** add marketplaces asynchronously ([#4766](https://github.com/cyberdak/deepagents/issues/4766)) ([0d1bb6a](https://github.com/cyberdak/deepagents/commit/0d1bb6a1224b91cae9dcdb7014a6410a82b79001))
* **code:** align context diff rows with changed rows ([#4714](https://github.com/cyberdak/deepagents/issues/4714)) ([f9915db](https://github.com/cyberdak/deepagents/commit/f9915db4206ef2d794ad07fdccbdd4ee58963142))
* **code:** allow `/remember` with args when no conversation history ([#4418](https://github.com/cyberdak/deepagents/issues/4418)) ([5df9c83](https://github.com/cyberdak/deepagents/commit/5df9c83b58f2529561848ae9f1364961e1c80641))
* **code:** allow cleanup of agent-created scratch files ([#4860](https://github.com/cyberdak/deepagents/issues/4860)) ([fe08582](https://github.com/cyberdak/deepagents/commit/fe08582a386b86f78f7a8047db067ea45e7e2650))
* **code:** allow safe OS-temp scratch artifacts ([#4869](https://github.com/cyberdak/deepagents/issues/4869)) ([4330534](https://github.com/cyberdak/deepagents/commit/4330534d18cbf79260842dde0e0c450312ef55ca))
* **code:** allow suppressing LangSmith key override warning ([#4436](https://github.com/cyberdak/deepagents/issues/4436)) ([ddcae5e](https://github.com/cyberdak/deepagents/commit/ddcae5e0bd9aebc946be1d9fb3f5e35eeb690fa6))
* **code:** authorize Auto actions from active goal/rubric directives ([#5017](https://github.com/cyberdak/deepagents/issues/5017)) ([728dbe7](https://github.com/cyberdak/deepagents/commit/728dbe7df62ad9960f21cabd6e6c37e8d9a66da7))
* **code:** avoid blocking MCP OAuth token refresh ([#4770](https://github.com/cyberdak/deepagents/issues/4770)) ([3b2ffce](https://github.com/cyberdak/deepagents/commit/3b2ffce923e06370efe177e9ca91f70e86f19602))
* **code:** avoid duplicate "criteria ready" message on `/goal` revisions ([#4559](https://github.com/cyberdak/deepagents/issues/4559)) ([1110497](https://github.com/cyberdak/deepagents/commit/1110497e17fac6deceb9d1d6e530f9197bfc0d4a))
* **code:** avoid redundant Auto approval prompts ([#4993](https://github.com/cyberdak/deepagents/issues/4993)) ([9975874](https://github.com/cyberdak/deepagents/commit/9975874d897ada8979c084145eb730e15c9cf979))
* **code:** avoid repeated startup auto-update stalls ([#4648](https://github.com/cyberdak/deepagents/issues/4648)) ([12a9c9d](https://github.com/cyberdak/deepagents/commit/12a9c9d6813a83e5eeff9feed0c4068d1fcc69c4))
* **code:** avoid tracking inline restart callers ([#4894](https://github.com/cyberdak/deepagents/issues/4894)) ([0b071ef](https://github.com/cyberdak/deepagents/commit/0b071ef71a1f0d63cb09de7ac528e030cd75af2e))
* **code:** bust CDN cache on forced `dcode update` checks ([#4862](https://github.com/cyberdak/deepagents/issues/4862)) ([3733526](https://github.com/cyberdak/deepagents/commit/3733526f5faa187627c650435fa5478754c55fb4))
* **code:** capture input typed before TUI startup ([#4684](https://github.com/cyberdak/deepagents/issues/4684)) ([ef9a4a8](https://github.com/cyberdak/deepagents/commit/ef9a4a8770f4daec70e640d6d2f23dd798d4ede2))
* **code:** clarify managed `rg` install failures ([#4578](https://github.com/cyberdak/deepagents/issues/4578)) ([434c84a](https://github.com/cyberdak/deepagents/commit/434c84ae144b0319afe37d6f2dbadfd7f5fc9f70))
* **code:** clarify plugin component discovery and reload status ([#4774](https://github.com/cyberdak/deepagents/issues/4774)) ([7d707b8](https://github.com/cyberdak/deepagents/commit/7d707b840f132ad65e5ac8443ec7fece393180f8))
* **code:** clean offloaded history when deleting a thread ([#4751](https://github.com/cyberdak/deepagents/issues/4751)) ([47788ed](https://github.com/cyberdak/deepagents/commit/47788ededafd44f74b4368ec6793bf4685ad3a3a))
* **code:** clear transient update launch status ([#4355](https://github.com/cyberdak/deepagents/issues/4355)) ([b870b18](https://github.com/cyberdak/deepagents/commit/b870b18750f65442009028a85a2ac18f1b06640c))
* **code:** close subprocess transport on install teardown ([#4735](https://github.com/cyberdak/deepagents/issues/4735)) ([625e601](https://github.com/cyberdak/deepagents/commit/625e601da8cd77e13b98b2b81626f320478108dc))
* **code:** complete goals after satisfied grading ([#4781](https://github.com/cyberdak/deepagents/issues/4781)) ([682ce0f](https://github.com/cyberdak/deepagents/commit/682ce0fc760e96cf546ea9c97050293548aebc45))
* **code:** consistent modal backdrop dimming for selectors ([#4990](https://github.com/cyberdak/deepagents/issues/4990)) ([3606e3f](https://github.com/cyberdak/deepagents/commit/3606e3f3fa2faac97f30141f9ee54e37631d16ad))
* **code:** count only running tools in live tool-group line ([#4809](https://github.com/cyberdak/deepagents/issues/4809)) ([4d483fd](https://github.com/cyberdak/deepagents/commit/4d483fdf39b6d7c691322041a4fc58be06ecfd6b))
* **code:** dedupe Auto classifier-unavailable transcript spam ([#5013](https://github.com/cyberdak/deepagents/issues/5013)) ([9500306](https://github.com/cyberdak/deepagents/commit/9500306a17f90dc2f27897c364c24cafffbc474a))
* **code:** dedupe update/install log path output ([#4553](https://github.com/cyberdak/deepagents/issues/4553)) ([1398fee](https://github.com/cyberdak/deepagents/commit/1398feeca507cab9ec51a66604d46c747f7fcd2f))
* **code:** deduplicate content from system prompt by overwriting base prompt ([#4516](https://github.com/cyberdak/deepagents/issues/4516)) ([2266f58](https://github.com/cyberdak/deepagents/commit/2266f58e4713d23ba0b30eb8646424d01165c11b))
* **code:** detach owned `langgraph dev` server from terminal ([#4642](https://github.com/cyberdak/deepagents/issues/4642)) ([d1f3afe](https://github.com/cyberdak/deepagents/commit/d1f3afecdc015b5d1c9fb098d6347c7d7180e417))
* **code:** disable LangSmith secret redaction by default ([#4970](https://github.com/cyberdak/deepagents/issues/4970)) ([d029585](https://github.com/cyberdak/deepagents/commit/d029585ab79432d00edfa5a70e77a31f2388ed5b))
* **code:** disentangle version diagnostics for editable installs ([#4816](https://github.com/cyberdak/deepagents/issues/4816)) ([7408378](https://github.com/cyberdak/deepagents/commit/7408378896344e4db7dbc45a35ae6b02cc746d31))
* **code:** dismiss startup tip on `-m` initial submission ([#4779](https://github.com/cyberdak/deepagents/issues/4779)) ([8acd414](https://github.com/cyberdak/deepagents/commit/8acd414a2e712d8b8b1968e40bff40483196856b))
* **code:** drop `uv install` tip from `/version` update hint ([#4822](https://github.com/cyberdak/deepagents/issues/4822)) ([4e618f0](https://github.com/cyberdak/deepagents/commit/4e618f07b4b00f94133b4d1c105011c438cb35be))
* **code:** ensure unique message widget IDs on history load ([#4454](https://github.com/cyberdak/deepagents/issues/4454)) ([de2f7d2](https://github.com/cyberdak/deepagents/commit/de2f7d2835485df905772e1c96e33d2c239d8e22))
* **code:** flag empty env override shadowing LangSmith key in `/trace` ([#4996](https://github.com/cyberdak/deepagents/issues/4996)) ([313f952](https://github.com/cyberdak/deepagents/commit/313f9520cef28c105aa53eac645176d422ec4a97))
* **code:** full-width chat messages, hide scrollbar, flush input bg ([#4374](https://github.com/cyberdak/deepagents/issues/4374)) ([1f8e8dc](https://github.com/cyberdak/deepagents/commit/1f8e8dc942ac54c4014ac48f9345ee0201be0b1b))
* **code:** give `config get` a useful missing-key message ([#4976](https://github.com/cyberdak/deepagents/issues/4976)) ([260c33e](https://github.com/cyberdak/deepagents/commit/260c33ee28ade91741ba226ef3e719b6b8c8c02c))
* **code:** harden approval content rendering ([#4581](https://github.com/cyberdak/deepagents/issues/4581)) ([38446fd](https://github.com/cyberdak/deepagents/commit/38446fda649b891dd8604e788701eabe739c1dd0))
* **code:** harden Hooks v2 command execution ([#4917](https://github.com/cyberdak/deepagents/issues/4917)) ([05dd0d1](https://github.com/cyberdak/deepagents/commit/05dd0d1bee7d79be6ac7f18db0d05b521e760326))
* **code:** harden installer downloads and paths ([#4871](https://github.com/cyberdak/deepagents/issues/4871)) ([9a5bbeb](https://github.com/cyberdak/deepagents/commit/9a5bbeb7558405054e970decfc1aef5b96a026f3))
* **code:** hide `Auto` option in approval widget when ineligible ([#4839](https://github.com/cyberdak/deepagents/issues/4839)) ([1a1f06f](https://github.com/cyberdak/deepagents/commit/1a1f06f506d5a167609de336cced740151b6615a))
* **code:** honest MCP OAuth callback close message ([#4410](https://github.com/cyberdak/deepagents/issues/4410)) ([ef637f4](https://github.com/cyberdak/deepagents/commit/ef637f4a3f38ee155ad7d31e64a5cdd7bfaee62c))
* **code:** honor MCP server disables for plugins ([#4848](https://github.com/cyberdak/deepagents/issues/4848)) ([eea0a84](https://github.com/cyberdak/deepagents/commit/eea0a84d9621565a707c161c2f22878771d9b38b))
* **code:** hydrate transcript tail when scrolled to the bottom edge ([#4733](https://github.com/cyberdak/deepagents/issues/4733)) ([02a2461](https://github.com/cyberdak/deepagents/commit/02a246144c764a1c57b60223652ade8716c7529b))
* **code:** hydrate virtualized transcript on scroll offset changes ([#4646](https://github.com/cyberdak/deepagents/issues/4646)) ([f77eeb0](https://github.com/cyberdak/deepagents/commit/f77eeb0a036281f84bf7d0b05ea60e02630f55c1))
* **code:** ignore LangSmith default US endpoint as custom target ([#5022](https://github.com/cyberdak/deepagents/issues/5022)) ([ffb7aab](https://github.com/cyberdak/deepagents/commit/ffb7aabe25d3d5ad7c5fce139f3bc3e14e245adf))
* **code:** improve `/rubric` help and empty-state messaging ([#5015](https://github.com/cyberdak/deepagents/issues/5015)) ([1a3f46b](https://github.com/cyberdak/deepagents/commit/1a3f46b85861779ed44e880cc7921cdd6f28fdfa))
* **code:** improve empty marketplace onboarding and list polish ([#4759](https://github.com/cyberdak/deepagents/issues/4759)) ([ab2e101](https://github.com/cyberdak/deepagents/commit/ab2e101d02d0fc5be45b0581c4e04d441402dc29))
* **code:** infer additional model providers ([#4675](https://github.com/cyberdak/deepagents/issues/4675)) ([4ceed24](https://github.com/cyberdak/deepagents/commit/4ceed24d3758801ed9df1024602e90488004cef1))
* **code:** infer Fireworks provider from qualified model IDs ([#4594](https://github.com/cyberdak/deepagents/issues/4594)) ([4d2aa8a](https://github.com/cyberdak/deepagents/commit/4d2aa8a9684609eee45cd93b0af5149d8dd09eea))
* **code:** inject OpenAI `prompt_cache_key` for any OpenAI-provider endpoint ([#4995](https://github.com/cyberdak/deepagents/issues/4995)) ([6d6632f](https://github.com/cyberdak/deepagents/commit/6d6632fa39822f1b774fcabd61ed371a90427113))
* **code:** keep `task` timers monotonic across nested subagent HITL ([#4771](https://github.com/cyberdak/deepagents/issues/4771)) ([6952011](https://github.com/cyberdak/deepagents/commit/69520118a7f96866a5e92e7b31894d8ba3312938))
* **code:** keep chat input responsive during `/restart` ([#4808](https://github.com/cyberdak/deepagents/issues/4808)) ([a915c59](https://github.com/cyberdak/deepagents/commit/a915c590dfb7c50d9bf697953ce724bad8dd4149))
* **code:** keep chat input responsive during MCP viewer `Ctrl+R` reconnect ([#4753](https://github.com/cyberdak/deepagents/issues/4753)) ([28dc96d](https://github.com/cyberdak/deepagents/commit/28dc96d08bc057f2e435b557062a819db4191310))
* **code:** keep finished calls on live tool-group line ([#4927](https://github.com/cyberdak/deepagents/issues/4927)) ([976c54b](https://github.com/cyberdak/deepagents/commit/976c54b2e1392282044d9890a4a5d5d655f3e8dc))
* **code:** keep footer branch visible and ellipsized instead of hiding when narrow ([#4506](https://github.com/cyberdak/deepagents/issues/4506)) ([ccf30c3](https://github.com/cyberdak/deepagents/commit/ccf30c342e5ead677aafd196d8f1ddd2bdf95196))
* **code:** keep goal criteria proposal when marker clear fails ([#4785](https://github.com/cyberdak/deepagents/issues/4785)) ([487b25f](https://github.com/cyberdak/deepagents/commit/487b25f885c74b43ad2df837c6c0f6c45626be2a))
* **code:** keep harness-profile diagnostics out of terminal output ([#4943](https://github.com/cyberdak/deepagents/issues/4943)) ([812bae4](https://github.com/cyberdak/deepagents/commit/812bae4afad6749add097f9d58e489df9ec703a2))
* **code:** keep notification center open for API-key entry ([#4568](https://github.com/cyberdak/deepagents/issues/4568)) ([6e89417](https://github.com/cyberdak/deepagents/commit/6e8941776cdcc35909da305f3bb39500c0f479cb))
* **code:** keep paste placeholder when backspacing newline below it ([#4757](https://github.com/cyberdak/deepagents/issues/4757)) ([ea82538](https://github.com/cyberdak/deepagents/commit/ea825386b3c817f8461ea9e92c71de3411991e2a))
* **code:** keep TODO and edit tools expanded ([#4704](https://github.com/cyberdak/deepagents/issues/4704)) ([1d549d3](https://github.com/cyberdak/deepagents/commit/1d549d3f3c9bb60c3ce39d4a0c913bcefe9610d5))
* **code:** log underlying Auto classifier failures ([#5011](https://github.com/cyberdak/deepagents/issues/5011)) ([bd03e8a](https://github.com/cyberdak/deepagents/commit/bd03e8a1ca4b38883e11148d5614a444cdefa407))
* **code:** make `/goal` completion and grading reliable ([#4691](https://github.com/cyberdak/deepagents/issues/4691)) ([9da63c6](https://github.com/cyberdak/deepagents/commit/9da63c64a59503e3366e9bc7224cb1251af476be))
* **code:** make Auto mode generally available ([#4957](https://github.com/cyberdak/deepagents/issues/4957)) ([1709dbf](https://github.com/cyberdak/deepagents/commit/1709dbf9b27766aacce1a5a9c17396b3654f026c))
* **code:** make execute command expandable in code TUI transcript ([#4428](https://github.com/cyberdak/deepagents/issues/4428)) ([d999181](https://github.com/cyberdak/deepagents/commit/d999181e8424498681f1e442c71380bf6b82b0aa))
* **code:** make markdown `AppMessage` output selectable ([#4814](https://github.com/cyberdak/deepagents/issues/4814)) ([2d6b2ce](https://github.com/cyberdak/deepagents/commit/2d6b2ceeda97f8c77d1b3ea70c674b076e7d713f))
* **code:** make YOLO warning friendlier for new users ([#4950](https://github.com/cyberdak/deepagents/issues/4950)) ([fe07f39](https://github.com/cyberdak/deepagents/commit/fe07f39ad78c5c09ea6959540a49196cd2f47f3e))
* **code:** match primary-input `Ctrl+D` behavior in inline free-text fields ([#4729](https://github.com/cyberdak/deepagents/issues/4729)) ([8a6963b](https://github.com/cyberdak/deepagents/commit/8a6963ba52eee2ab8de5df2c14210f472c828d38))
* **code:** move Auto mode path checks off the event loop ([#4856](https://github.com/cyberdak/deepagents/issues/4856)) ([511203a](https://github.com/cyberdak/deepagents/commit/511203a2c247f6756af3f06581ab9af761a4c4ef))
* **code:** omit `plugins/` and `conversation_history/` from `/agent` picker ([#4991](https://github.com/cyberdak/deepagents/issues/4991)) ([db26688](https://github.com/cyberdak/deepagents/commit/db26688eee32232a1b73e98cc02642b5bf4165f4))
* **code:** partition Debug Console log retention by level ([#4718](https://github.com/cyberdak/deepagents/issues/4718)) ([c6e3b35](https://github.com/cyberdak/deepagents/commit/c6e3b351f1826aa6ea97be244acd867950a032ee))
* **code:** persist resume model state privately ([#4400](https://github.com/cyberdak/deepagents/issues/4400)) ([bbd0f0d](https://github.com/cyberdak/deepagents/commit/bbd0f0d1ddc9d22d399a819d7b4363f7997d119e))
* **code:** persist rubric model after server restart ([#4419](https://github.com/cyberdak/deepagents/issues/4419)) ([5605a68](https://github.com/cyberdak/deepagents/commit/5605a681c9fec888d8c6dfbde2decd4692c8cef0))
* **code:** pin filelock below 3.30 to avoid blocking import ([#4786](https://github.com/cyberdak/deepagents/issues/4786)) ([f9b7d75](https://github.com/cyberdak/deepagents/commit/f9b7d75f24301081ae8973cd59f00e609eb024c5))
* **code:** preflight Ollama host reachability before discovery probe ([#4702](https://github.com/cyberdak/deepagents/issues/4702)) ([96fe71a](https://github.com/cyberdak/deepagents/commit/96fe71a3815e1020edeb3be1af70b0cadb85931c))
* **code:** preserve `Ctrl+D` deletion in non-empty input ([#4626](https://github.com/cyberdak/deepagents/issues/4626)) ([306bd89](https://github.com/cyberdak/deepagents/commit/306bd893f214237b6b4eede7c2ce0eaff66f5527))
* **code:** preserve remembered MCP approvals with env allowlist ([#4889](https://github.com/cyberdak/deepagents/issues/4889)) ([b513bf3](https://github.com/cyberdak/deepagents/commit/b513bf3b2aaa30738da9b9b0ced1c001efb1bd5a))
* **code:** preserve transcript order during virtualization ([#4549](https://github.com/cyberdak/deepagents/issues/4549)) ([f6ee70c](https://github.com/cyberdak/deepagents/commit/f6ee70c00ac6ad7b1b180155018b794308a18361))
* **code:** prevent `UnicodeEncodeError` crash in non-interactive mode on legacy Windows consoles ([#4478](https://github.com/cyberdak/deepagents/issues/4478)) ([b1b16cd](https://github.com/cyberdak/deepagents/commit/b1b16cd114d4ee4f077cf5824a0176cd94ebd851))
* **code:** prevent failed exit setup from stranding the app ([#4913](https://github.com/cyberdak/deepagents/issues/4913)) ([e4d69b0](https://github.com/cyberdak/deepagents/commit/e4d69b04a84de226d26d9ca3adea96f1337eef04))
* **code:** probe unreachable Ollama daemon once per reload ([#4806](https://github.com/cyberdak/deepagents/issues/4806)) ([45baf6c](https://github.com/cyberdak/deepagents/commit/45baf6c7a47e08e656ba56eb76beea30a9956403))
* **code:** put field descriptions on first-party tool schemas ([#5019](https://github.com/cyberdak/deepagents/issues/5019)) ([4ccb873](https://github.com/cyberdak/deepagents/commit/4ccb87325f3f97e416683233c94405e3ee105cda))
* **code:** put local offloaded tool results on the real filesystem ([#4740](https://github.com/cyberdak/deepagents/issues/4740)) ([36051e2](https://github.com/cyberdak/deepagents/commit/36051e2a6cdcd9c22f6118f5cfc481e0540913ea))
* **code:** queue `/mcp login` sent before the server connects ([#4533](https://github.com/cyberdak/deepagents/issues/4533)) ([edac82c](https://github.com/cyberdak/deepagents/commit/edac82c837de8e12b58b97ac25acc31f743d4c5d))
* **code:** quiet expected non-repo `git ls-files` logging ([#4701](https://github.com/cyberdak/deepagents/issues/4701)) ([3d499db](https://github.com/cyberdak/deepagents/commit/3d499db8a6c76743810a8983107d7c7d7bdb35e6))
* **code:** quiet MCP auth-skip debug logging for known patterns ([#4805](https://github.com/cyberdak/deepagents/issues/4805)) ([c2c27d6](https://github.com/cyberdak/deepagents/commit/c2c27d621b63d5af18870e034f99355dc410cbda))
* **code:** quiet routine ripgrep installer output ([#4417](https://github.com/cyberdak/deepagents/issues/4417)) ([a52c18d](https://github.com/cyberdak/deepagents/commit/a52c18d3ef8fe462d1289dca8798c51450e0368a))
* **code:** quit with `Ctrl+D` at end of prompt ([#4678](https://github.com/cyberdak/deepagents/issues/4678)) ([2f8c111](https://github.com/cyberdak/deepagents/commit/2f8c11176f5cc9350c3337b2dfcf9f19886d5d02))
* **code:** re-apply theme preference on `/reload` ([#4514](https://github.com/cyberdak/deepagents/issues/4514)) ([5d1c392](https://github.com/cyberdak/deepagents/commit/5d1c3928f7ca0ea97f28fd4d34ae1a4ee885e888))
* **code:** reap langgraph dev server when startup is cancelled ([#4629](https://github.com/cyberdak/deepagents/issues/4629)) ([904ff05](https://github.com/cyberdak/deepagents/commit/904ff05620a576100e05fd65810d38405c4942d4))
* **code:** redact LangSmith trace secrets by default ([#4356](https://github.com/cyberdak/deepagents/issues/4356)) ([5e01fec](https://github.com/cyberdak/deepagents/commit/5e01fec72d8b179a3b075b07268162d2eaebfe84))
* **code:** reject `--auto-approve` in headless mode ([#4617](https://github.com/cyberdak/deepagents/issues/4617)) ([997be16](https://github.com/cyberdak/deepagents/commit/997be1643aff6d6900b8b8c95832cdf93be8c0d7))
* **code:** remove MCP OAuth success page message shift ([#4463](https://github.com/cyberdak/deepagents/issues/4463)) ([69bb06c](https://github.com/cyberdak/deepagents/commit/69bb06c0680fa6d37b917deb6b70927c3eff9c09))
* **code:** remove misleading agent names from help ([#4671](https://github.com/cyberdak/deepagents/issues/4671)) ([ac15732](https://github.com/cyberdak/deepagents/commit/ac1573281530c1564fe07f8a21608e4d4dec2c3b))
* **code:** rename `ls_agent_kind` to `ls_agent_purpose` ([#4708](https://github.com/cyberdak/deepagents/issues/4708)) ([2678b16](https://github.com/cyberdak/deepagents/commit/2678b1680d8928e72e8efae00632a694c9b2737a))
* **code:** report Auto classifier timeout budget ([#5025](https://github.com/cyberdak/deepagents/issues/5025)) ([516619b](https://github.com/cyberdak/deepagents/commit/516619b7bf516e56f0e56ebc319dcab928c68c40))
* **code:** resolve `/threads` header link on mount, not after load ([#4453](https://github.com/cyberdak/deepagents/issues/4453)) ([4cba728](https://github.com/cyberdak/deepagents/commit/4cba72893fc4aae5b429d8c573c1a513d97ddf8a))
* **code:** resolve editable SDK version metadata ([#4394](https://github.com/cyberdak/deepagents/issues/4394)) ([3239bf4](https://github.com/cyberdak/deepagents/commit/3239bf4edf2be3037bb18315463ac6a0c3537e5c))
* **code:** restore `"Server log preserved at:"` notice on exit ([#4999](https://github.com/cyberdak/deepagents/issues/4999)) ([5bc7714](https://github.com/cyberdak/deepagents/commit/5bc7714fe55a73ac4892deb1785522ea310607ce))
* **code:** restore caller's LangSmith API key in shell subprocess env ([#4458](https://github.com/cyberdak/deepagents/issues/4458)) ([9293b19](https://github.com/cyberdak/deepagents/commit/9293b190170a872b73d0d94e66479bcc5f7962c7))
* **code:** restore marketplace details keyboard focus [closes DCD-50] ([#4763](https://github.com/cyberdak/deepagents/issues/4763)) ([e821d3d](https://github.com/cyberdak/deepagents/commit/e821d3dd26e8cd0c6ada1a44ceaceddad9f5ee80))
* **code:** restore welcome banner tips ([#4528](https://github.com/cyberdak/deepagents/issues/4528)) ([3f1e55e](https://github.com/cyberdak/deepagents/commit/3f1e55eafbc1fde79cb75f631561cf35d4b8ff4c))
* **code:** route `ctrl+x` to focused `ask_user` input ([#4926](https://github.com/cyberdak/deepagents/issues/4926)) ([005f9bb](https://github.com/cyberdak/deepagents/commit/005f9bb4d790e6cd92be8712ec86cd45192b699f))
* **code:** route Anthropic effort through output config ([#4446](https://github.com/cyberdak/deepagents/issues/4446)) ([1e8ed81](https://github.com/cyberdak/deepagents/commit/1e8ed81940a862dde44f704826b61650336367e0))
* **code:** route explicit `--stdin` + `--skill` to headless path ([#4611](https://github.com/cyberdak/deepagents/issues/4611)) ([724e24a](https://github.com/cyberdak/deepagents/commit/724e24a31546e1f31feca3bb2344717550682595))
* **code:** run `/offload` server-side ([#4696](https://github.com/cyberdak/deepagents/issues/4696)) ([564e5a0](https://github.com/cyberdak/deepagents/commit/564e5a05bca5236ae33ce1147865111f931d257c))
* **code:** run MCP login during a run, queue the restart ([#4643](https://github.com/cyberdak/deepagents/issues/4643)) ([65e1ee8](https://github.com/cyberdak/deepagents/commit/65e1ee802e2f69762a6d8e6c7c6d37060161ea5a))
* **code:** run stdio MCP server pre-flight check off the event loop ([#4434](https://github.com/cyberdak/deepagents/issues/4434)) ([c9636e2](https://github.com/cyberdak/deepagents/commit/c9636e22725a5bd32c1f8b9e739b02b4aa7c3dc7))
* **code:** serialize MCP OAuth token refreshes to prevent reuse revocation ([#4565](https://github.com/cyberdak/deepagents/issues/4565)) ([c37100d](https://github.com/cyberdak/deepagents/commit/c37100d4763e527fce12fa4451794ca25ded7640))
* **code:** share MCP approvals across Git worktrees ([#4939](https://github.com/cyberdak/deepagents/issues/4939)) ([467f9dd](https://github.com/cyberdak/deepagents/commit/467f9dd0400087c2918bcf19f270bd934cec623a))
* **code:** share paste handling with inline free-text prompts ([#4736](https://github.com/cyberdak/deepagents/issues/4736)) ([369ec69](https://github.com/cyberdak/deepagents/commit/369ec6920af35cdec713b9e27d0d1816cafaf556))
* **code:** show "Took &lt;duration&gt;" when `task` tool completes ([#4638](https://github.com/cyberdak/deepagents/issues/4638)) ([19538e0](https://github.com/cyberdak/deepagents/commit/19538e0a46a5c2c050412b79fd45608a63cdde52))
* **code:** show `-m` prompt as queued immediately on startup ([#4861](https://github.com/cyberdak/deepagents/issues/4861)) ([d0e148a](https://github.com/cyberdak/deepagents/commit/d0e148a72612137fc7bc1e49a8972643e0ca2c28))
* **code:** show `(local)` tag under ANSI themes ([#4534](https://github.com/cyberdak/deepagents/issues/4534)) ([699e439](https://github.com/cyberdak/deepagents/commit/699e439699723e477a621f95eef87a7d76aac5f5))
* **code:** show Auto enable notice modal only on first global enable ([#5012](https://github.com/cyberdak/deepagents/issues/5012)) ([c2dbd17](https://github.com/cyberdak/deepagents/commit/c2dbd176f06ff1a29637107101ae61344a09fc59))
* **code:** show loading state during model switch ([#4209](https://github.com/cyberdak/deepagents/issues/4209)) ([7cc4e9f](https://github.com/cyberdak/deepagents/commit/7cc4e9f9bda5a8ae42bb072b82b634ad8c39ade1))
* **code:** show rubric grader defaults ([#4966](https://github.com/cyberdak/deepagents/issues/4966)) ([465b9de](https://github.com/cyberdak/deepagents/commit/465b9de17f9f4e6cd07a8674d9a186e60f5bf4d4))
* **code:** skip Esc prompt-restore once output generation begins ([#4582](https://github.com/cyberdak/deepagents/issues/4582)) ([14f384f](https://github.com/cyberdak/deepagents/commit/14f384fc0083c07a7f44f97543b40b74cf93c13f))
* **code:** skip grading during `/goal` proposals ([#4941](https://github.com/cyberdak/deepagents/issues/4941)) ([d1ce66e](https://github.com/cyberdak/deepagents/commit/d1ce66ea03e3726e6077c6700fc480209a849a7e))
* **code:** strip input before Ctrl+C copy-input fallback ([#4590](https://github.com/cyberdak/deepagents/issues/4590)) ([505d55a](https://github.com/cyberdak/deepagents/commit/505d55ad83e8569213175911ee6c8c39fbbf340c))
* **code:** strip media placeholders from model-facing message text ([#4462](https://github.com/cyberdak/deepagents/issues/4462)) ([aa0ae36](https://github.com/cyberdak/deepagents/commit/aa0ae36b00df6411a9200610a9075ef2dc28b1af))
* **code:** support plain `exit` quit command ([#4543](https://github.com/cyberdak/deepagents/issues/4543)) ([e6f10a1](https://github.com/cyberdak/deepagents/commit/e6f10a149051128677c9f6f37663922054a7ac26))
* **code:** support unambiguous `read_file` gutters ([#4711](https://github.com/cyberdak/deepagents/issues/4711)) ([2089b54](https://github.com/cyberdak/deepagents/commit/2089b54e2a674ede313e790b59febf9dc6f22571))
* **code:** suppress expected MCP reauth logs ([#4359](https://github.com/cyberdak/deepagents/issues/4359)) ([15ee384](https://github.com/cyberdak/deepagents/commit/15ee384117ccd955f7481346dd92b7f4b007a60d))
* **code:** surface `langchain-quickjs` in `/version` core deps ([#4813](https://github.com/cyberdak/deepagents/issues/4813)) ([4112392](https://github.com/cyberdak/deepagents/commit/41123924da6f6aa0243b51f2374210bee86df089))
* **code:** surface tool calls awaiting approval ([#4739](https://github.com/cyberdak/deepagents/issues/4739)) ([8148724](https://github.com/cyberdak/deepagents/commit/814872492eb2bed4d5c382c6c1fe985ad4354b68))
* **code:** sync `ask_user` active-question highlight with focus ([#4599](https://github.com/cyberdak/deepagents/issues/4599)) ([e4c29b5](https://github.com/cyberdak/deepagents/commit/e4c29b5264413d23d8dc70cabae72feb5f3f3dcb))
* **code:** targeted uv constraints for dcode prerelease deps ([#4744](https://github.com/cyberdak/deepagents/issues/4744)) ([36c4024](https://github.com/cyberdak/deepagents/commit/36c40241b85ec5b0452d9ca334e5f09b95dc16aa))
* **code:** thread id always copies on click in Debug Console ([#4945](https://github.com/cyberdak/deepagents/issues/4945)) ([b4cb393](https://github.com/cyberdak/deepagents/commit/b4cb3937bf8883e616f47621547a775ce9b29995))
* **code:** trim `web_search` and `fetch_url` tool descriptions ([#5016](https://github.com/cyberdak/deepagents/issues/5016)) ([170b4a6](https://github.com/cyberdak/deepagents/commit/170b4a6c4590b3f95fb5219b5d9074c7f01a1937))
* **code:** unblock MCP force reconnect modal ([#4396](https://github.com/cyberdak/deepagents/issues/4396)) ([8b7eab0](https://github.com/cyberdak/deepagents/commit/8b7eab023db686f577d16f4f9ac872205baf136f))
* **code:** use SDK pin as effective editable version ([#4949](https://github.com/cyberdak/deepagents/issues/4949)) ([1b270c8](https://github.com/cyberdak/deepagents/commit/1b270c86fe24381c28d3ed35a31d754bd58bbf6e))
* **code:** warm MCP auth imports off event loop ([#4855](https://github.com/cyberdak/deepagents/issues/4855)) ([75d37c3](https://github.com/cyberdak/deepagents/commit/75d37c347556d962ff14850bdde489657c86feb4))
* **code:** wrap MCP viewer navigation ([#4677](https://github.com/cyberdak/deepagents/issues/4677)) ([cffc732](https://github.com/cyberdak/deepagents/commit/cffc73213bfdcec26cb82c413fa7e27db4afc0ca))


### Performance Improvements

* **code:** background refresh for `@` file completion cache ([#3911](https://github.com/cyberdak/deepagents/issues/3911)) ([aa22d6b](https://github.com/cyberdak/deepagents/commit/aa22d6b6d5a49e4d6c3aa2d4932df75d14d65f78))
* **code:** coordinate async shutdown teardown to cut exit latency ([#4831](https://github.com/cyberdak/deepagents/issues/4831)) ([a2e501b](https://github.com/cyberdak/deepagents/commit/a2e501b71f3d91769f56d5b3e433af8e03f7656e))
* **code:** load MCP servers concurrently during graph build ([#4659](https://github.com/cyberdak/deepagents/issues/4659)) ([c5345cc](https://github.com/cyberdak/deepagents/commit/c5345cc04cd810c6238e42dfbfa14497ae1b9020))
* **code:** make `threads list` fast on large session databases ([#4005](https://github.com/cyberdak/deepagents/issues/4005)) ([85ca01a](https://github.com/cyberdak/deepagents/commit/85ca01a43b002c2bdb4205f48fac5fa6f66a3276))
* **code:** speed up local context detection ([#4922](https://github.com/cyberdak/deepagents/issues/4922)) ([0b512d4](https://github.com/cyberdak/deepagents/commit/0b512d4b79b1a03c7e452f1e76350cf726b1ec38))
* **code:** speed up shutdown after Ctrl+C/Ctrl+D ([#4351](https://github.com/cyberdak/deepagents/issues/4351)) ([db441ed](https://github.com/cyberdak/deepagents/commit/db441ed306a8e03fb68f2ae6a2c08523e248976d))


### Reverted Changes

* **code,sdk:** revert `SystemPromptConfig` ([#4969](https://github.com/cyberdak/deepagents/issues/4969)) ([d046427](https://github.com/cyberdak/deepagents/commit/d046427b536c8ddbce5d804d6ae8b860511a9b44))
